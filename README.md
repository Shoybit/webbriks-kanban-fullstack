...
DATABASE\_URL=postgresql://postgres:postgres@localhost:5432/kanban\_db
...
Make sure PostgreSQL is running and the `DATABASE\_URL` in `backend/.env` points to the correct database.
